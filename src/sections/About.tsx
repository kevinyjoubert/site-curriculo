            ...
            <div className="sticky top-32">
              ...
              <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                {[
                  ...
                  'Dashboards',
                  'Automações em Google Sheets',
                  'Soluções com Google Apps Script',
                  'Integração com Ferramentas do Google'
                ].map(skill => (
                  <span
                    key={skill}
                    className="flex items-center justify-center text-center px-4 py-3 rounded-xl bg-zinc-900 border border-zinc-800 text-sm text-zinc-300 hover:border-indigo-500/50 transition-colors w-full"
                  >
                    {skill}
                  </span>
                ))}
