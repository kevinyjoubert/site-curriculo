...
export function About() {
  return (
    ...
    >
      ...
      {/* Glows sutis (continuação do Hero) */}
      {/* <div className="absolute top-1/3 -left-64 w-[500px] h-[500px] bg-indigo-500/10 rounded-full blur-3xl" />
      <div className="absolute bottom-[40px] right-[-200px] w-[400px] h-[400px] bg-purple-600/10 rounded-full blur-3xl" /> */}
